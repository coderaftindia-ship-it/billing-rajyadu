...
export default function POS() {
  ...
  return (
    <div className="min-h-screen flex flex-col pb-24 sm:pb-0 bg-slate-50">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-5 md:px-6 py-4 md:py-6">
        <div className="grid grid-cols-1 xl:grid-cols-[1.75fr_1.15fr] gap-6 max-w-full">
          <section className="space-y-6">
            ...
            <div className="bg-white rounded-4xl border border-slate-200 shadow-sm p-5 md:p-6 min-h-[24rem]">
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-4xl border border-slate-200 shadow-sm p-5 md:p-6 xl:sticky xl:top-6">
                    ...
                    >
                      ...
                      {customers.map((c) => (
                        <option key={c.id} value={c.id}>
                          {c.name} {c.phone && `(${c.phone})`}{c.gst ? ` - GST: ${c.gst.toUpperCase()}` : ''}
                        </option>
                      ))}
                    </select>
                    <button
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={async (e) => {
              ...
              const data = {
                ...
                gst: formData.get('gst') ? formData.get('gst').toUpperCase().trim() : '',
                credit: 0
              };
              ...
              <div>
                ...
                <input 
                  name="gst" 
                  className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 outline-none uppercase" 
